        ...
        <div class="card shadow border-0 m-4 mb-5 p-3">
            <form wire:submit="send">
                ...
                <div class="d-grid col-sm-12 col-lg-3">
                    <button type="submit" wire:loading.remove wire:target="send" class="btn btn-primary"
                        >Add Category</button>
                    <button wire:loading type="submit" class="btn btn-primary"
                        ...
                        <form wire:submit.prevent="updateLaundryCategory" method="post">
                            <div class="form-group">
                                ...
                                <div class="d-grid">
                                    ...
                                    <button type="submit" class="btn btn-primary" wire:loading.remove wire:target="" disabled>
                                       Processing.....
                                    </button>
                                </div>
                            </div>
