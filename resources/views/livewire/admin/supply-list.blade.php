                ...
                <form wire:submit="send" method="post">
                    <div class="form-group mt-4 mb-4">
                        ...
                        <div class="d-grid mb-3">
                            <button type="submit" class="btn btn-outline-primary" wire:loading.remove >submit </button>
                            <button type="submit" wire:loading wire:track="send" wire: class="btn btn-outline-primary"  disabled>Processing....</button>
                        </div>
                    </div>
                </form>
            </div>
